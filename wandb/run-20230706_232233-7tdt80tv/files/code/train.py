...
def run(args):
    ...
    train_loader = ZeroShotDataset(train_df, os.path.join(args.data_folder, "images"), gtrends, cat_dict, col_dict,
                                fab_dict, args.trend_len).get_loader(batch_size=args.batch_size, train=True)
    test_loader = ZeroShotDataset(test_df, os.path.join(args.data_folder, "images"), gtrends, cat_dict, col_dict,
